...
ActiveRecord::Schema.define(version: 2023_08_24_174831) do
  ...
  create_table "admin_data", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.text "sonyci_id"
  ...
  create_table "annotations", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "bulkrax_entries", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "bulkrax_exporter_runs", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "bulkrax_exporters", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.string "name"
    t.bigint "user_id"
  ...
  create_table "bulkrax_importer_runs", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "bulkrax_importers", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.string "name"
  ...
  create_table "bulkrax_pending_relationships", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
  ...
  create_table "bulkrax_statuses", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "checksum_audit_logs", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "collection_branding_infos", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "collection_type_participants", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "content_blocks", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.string "name"
    t.text "value"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "curation_concerns_operations", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.string "status"
  ...
  create_table "featured_works", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "file_download_stats", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.datetime "date"
    t.integer "downloads"
    t.string "file_id"
    t.datetime "created_at", null: false
  ...
  create_table "file_view_stats", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.datetime "date"
    t.integer "views"
    t.string "file_id"
    t.datetime "created_at", null: false
  ...
  create_table "hyrax_batch_ingest_batch_items", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.bigint "batch_id"
  ...
  create_table "hyrax_batch_ingest_batches", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.string "status"
  ...
  create_table "hyrax_collection_types", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.string "title"
    t.text "description"
    t.string "machine_id"
  ...
  create_table "hyrax_features", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "instantiation_admin_data", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "job_io_wrappers", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.bigint "user_id"
  ...
  create_table "mailboxer_conversation_opt_outs", id: :integer, charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "mailboxer_conversations", id: :integer, charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.string "subject", default: ""
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "mailboxer_notifications", id: :integer, charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.string "type"
    t.text "body"
    t.string "subject", default: ""
  ...
  create_table "mailboxer_receipts", id: :integer, charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "minter_states", id: :integer, charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "permission_template_accesses", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "permission_templates", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.string "source_id"
    t.string "visibility"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "proxy_deposit_requests", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "proxy_deposit_rights", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.bigint "grantor_id"
    t.bigint "grantee_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "pushes", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "qa_local_authorities", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "qa_local_authority_entries", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "roles", id: :integer, charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.string "name"
  end

  create_table "roles_users", id: false, charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.integer "role_id"
    t.integer "user_id"
  ...
  create_table "single_use_links", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "sipity_agents", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "sipity_comments", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "sipity_entities", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "sipity_entity_specific_responsibilities", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "sipity_notifiable_contexts", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "sipity_notification_recipients", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.integer "notification_id", null: false
  ...
  create_table "sipity_notifications", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "sipity_roles", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.string "name", null: false
    t.text "description"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "sipity_workflow_actions", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.integer "workflow_id", null: false
  ...
  create_table "sipity_workflow_methods", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "sipity_workflow_responsibilities", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.integer "agent_id", null: false
    t.integer "workflow_role_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "sipity_workflow_roles", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.integer "workflow_id", null: false
    t.integer "role_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "sipity_workflow_state_action_permissions", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.integer "workflow_role_id", null: false
  ...
  create_table "sipity_workflow_state_actions", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "sipity_workflow_states", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.integer "workflow_id", null: false
    t.string "name", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "sipity_workflows", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.string "name", null: false
    t.string "label"
    t.text "description"
    t.datetime "created_at", null: false
  ...
  create_table "sony_ci_webhook_logs", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.string "url"
    t.string "action"
  ...
  create_table "tinymce_assets", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.string "file"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "trophies", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.integer "user_id"
    t.string "work_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "uploaded_files", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.string "file"
    t.bigint "user_id"
  ...
  create_table "user_stats", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.integer "user_id"
    t.datetime "date"
  ...
  create_table "version_committers", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.string "obj_id"
  ...
  create_table "work_view_stats", charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.datetime "date"
    t.integer "work_views"
    t.string "work_id"
    t.datetime "created_at", null: false
