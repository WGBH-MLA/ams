...
ActiveRecord::Schema.define(version: 2024_03_07_194231) do
  ...
  create_table "admin_data", force: :cascade do |t|
    ...
    t.index ["bulkrax_importer_id"], name: "idx_20109_index_admin_data_on_bulkrax_importer_id"
    t.index ["hyrax_batch_ingest_batch_id"], name: "idx_20109_index_admin_data_on_hyrax_batch_ingest_batch_id"
  end
  ...
  create_table "annotations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["admin_data_id"], name: "idx_20116_index_annotations_on_admin_data_id"
  end
  ...
  create_table "bookmarks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["document_id"], name: "idx_20135_index_bookmarks_on_document_id"
    t.index ["user_id"], name: "idx_20135_index_bookmarks_on_user_id"
  end
  ...
  create_table "bulkrax_entries", force: :cascade do |t|
    ...
    t.index ["identifier"], name: "idx_20145_index_bulkrax_entries_on_identifier"
    t.index ["importerexporter_id", "importerexporter_type"], name: "idx_20145_bulkrax_entries_importerexporter_idx"
    t.index ["importerexporter_id"], name: "idx_20145_index_bulkrax_entries_on_importerexporter_id"
    t.index ["type"], name: "idx_20145_index_bulkrax_entries_on_type"
  end
  ...
  create_table "bulkrax_exporter_runs", force: :cascade do |t|
    ...
    t.index ["exporter_id"], name: "idx_20173_index_bulkrax_exporter_runs_on_exporter_id"
  end
  ...
  create_table "bulkrax_exporters", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "idx_20157_index_bulkrax_exporters_on_user_id"
  end
  ...
  create_table "bulkrax_importer_runs", force: :cascade do |t|
    ...
    t.index ["importer_id"], name: "idx_20194_index_bulkrax_importer_runs_on_importer_id"
  end
  ...
  create_table "bulkrax_importers", force: :cascade do |t|
    ...
    t.datetime "last_error_at"
    t.datetime "last_succeeded_at"
    t.index ["user_id"], name: "idx_20183_index_bulkrax_importers_on_user_id"
  end
  ...
  create_table "bulkrax_pending_relationships", force: :cascade do |t|
    ...
    t.index ["child_id"], name: "idx_20216_index_bulkrax_pending_relationships_on_child_id"
    t.index ["importer_run_id"], name: "idx_20216_index_bulkrax_pending_relationships_on_importer_run_i"
    t.index ["parent_id"], name: "idx_20216_index_bulkrax_pending_relationships_on_parent_id"
  end
  ...
  create_table "bulkrax_statuses", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["error_class"], name: "idx_20224_index_bulkrax_statuses_on_error_class"
    t.index ["runnable_id", "runnable_type"], name: "idx_20224_bulkrax_statuses_runnable_idx"
    t.index ["statusable_id", "statusable_type"], name: "idx_20224_bulkrax_statuses_statusable_idx"
  end
  ...
  create_table "checksum_audit_logs", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.boolean "passed"
    t.index ["checked_uri"], name: "idx_20235_index_checksum_audit_logs_on_checked_uri"
    t.index ["file_set_id", "file_id"], name: "idx_20235_by_file_set_id_and_file_id"
  end
  ...
  create_table "curation_concerns_operations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["lft"], name: "idx_20278_index_curation_concerns_operations_on_lft"
    t.index ["parent_id"], name: "idx_20278_index_curation_concerns_operations_on_parent_id"
    t.index ["rgt"], name: "idx_20278_index_curation_concerns_operations_on_rgt"
    t.index ["user_id"], name: "idx_20278_index_curation_concerns_operations_on_user_id"
  end
  ...
  create_table "featured_works", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["order"], name: "idx_20292_index_featured_works_on_order"
    t.index ["work_id"], name: "idx_20292_index_featured_works_on_work_id"
  end
  ...
  create_table "file_download_stats", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id"
    t.index ["file_id"], name: "idx_20299_index_file_download_stats_on_file_id"
    t.index ["user_id"], name: "idx_20299_index_file_download_stats_on_user_id"
  end
  ...
  create_table "file_view_stats", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id"
    t.index ["file_id"], name: "idx_20305_index_file_view_stats_on_file_id"
    t.index ["user_id"], name: "idx_20305_index_file_view_stats_on_user_id"
  end
  ...
  create_table "hyrax_batch_ingest_batch_items", force: :cascade do |t|
    ...
    t.index ["batch_id"], name: "idx_20324_index_hyrax_batch_ingest_batch_items_on_batch_id"
  end
  ...
  create_table "hyrax_collection_types", force: :cascade do |t|
    ...
    t.index ["machine_id"], name: "idx_20336_index_hyrax_collection_types_on_machine_id", unique: true
  end
  ...
  create_table "job_io_wrappers", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["uploaded_file_id"], name: "idx_20371_index_job_io_wrappers_on_uploaded_file_id"
    t.index ["user_id"], name: "idx_20371_index_job_io_wrappers_on_user_id"
  end
  ...
  create_table "mailboxer_conversation_opt_outs", force: :cascade do |t|
    ...
    t.index ["conversation_id"], name: "idx_20389_index_mailboxer_conversation_opt_outs_on_conversation"
    t.index ["unsubscriber_id", "unsubscriber_type"], name: "idx_20389_index_mailboxer_conversation_opt_outs_on_unsubscriber"
  end
  ...
  create_table "mailboxer_notifications", force: :cascade do |t|
    ...
    t.datetime "expires"
    t.index ["conversation_id"], name: "idx_20395_index_mailboxer_notifications_on_conversation_id"
    t.index ["notified_object_id", "notified_object_type"], name: "idx_20395_index_mailboxer_notifications_on_notified_object_id_a"
    ...
    t.index ["type"], name: "idx_20395_index_mailboxer_notifications_on_type"
  end
  ...
  create_table "mailboxer_receipts", force: :cascade do |t|
    ...
    t.index ["notification_id"], name: "idx_20410_index_mailboxer_receipts_on_notification_id"
    t.index ["receiver_id", "receiver_type"], name: "idx_20410_index_mailboxer_receipts_on_receiver_id_and_receiver_"
  end
  ...
  create_table "minter_states", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["namespace"], name: "idx_20425_index_minter_states_on_namespace", unique: true
  end
  ...
  create_table "permission_template_accesses", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["permission_template_id", "agent_id", "agent_type", "access"], name: "idx_20444_uk_permission_template_accesses", unique: true
    t.index ["permission_template_id"], name: "idx_20444_index_permission_template_accesses_on_permission_temp"
  end
  ...
  create_table "permission_templates", force: :cascade do |t|
    ...
    t.index ["source_id"], name: "idx_20434_index_permission_templates_on_source_id", unique: true
  end
  ...
  create_table "proxy_deposit_requests", force: :cascade do |t|
    ...
    t.index ["sending_user_id"], name: "idx_20454_index_proxy_deposit_requests_on_sending_user_id"
  end
  ...
  create_table "proxy_deposit_rights", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["grantee_id"], name: "idx_20462_index_proxy_deposit_rights_on_grantee_id"
  ...
  create_table "qa_local_authorities", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "idx_20474_index_qa_local_authorities_on_name", unique: true
  end
  ...
  create_table "qa_local_authority_entries", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["local_authority_id"], name: "idx_20480_index_qa_local_authority_entries_on_local_authority_i"
    t.index ["uri"], name: "idx_20480_index_qa_local_authority_entries_on_uri", unique: true
  end
  ...
  create_table "roles_users", id: false, force: :cascade do |t|
    t.bigint "role_id"
    t.bigint "user_id"
    t.index ["role_id", "user_id"], name: "idx_20494_index_roles_users_on_role_id_and_user_id"
    t.index ["role_id"], name: "idx_20494_index_roles_users_on_role_id"
    t.index ["user_id", "role_id"], name: "idx_20494_index_roles_users_on_user_id_and_role_id"
    t.index ["user_id"], name: "idx_20494_index_roles_users_on_user_id"
  end
  ...
  create_table "searches", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "idx_20501_index_searches_on_user_id"
  end
  ...
  create_table "sipity_agents", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["proxy_for_id", "proxy_for_type"], name: "idx_20519_sipity_agents_proxy_for", unique: true
  end
  ...
  create_table "sipity_comments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["agent_id"], name: "idx_20526_index_sipity_comments_on_agent_id"
    t.index ["created_at"], name: "idx_20526_index_sipity_comments_on_created_at"
    t.index ["entity_id"], name: "idx_20526_index_sipity_comments_on_entity_id"
  end
  ...
  create_table "sipity_entities", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["proxy_for_global_id"], name: "idx_20533_sipity_entities_proxy_for_global_id", unique: true
    t.index ["workflow_id"], name: "idx_20533_index_sipity_entities_on_workflow_id"
    t.index ["workflow_state_id"], name: "idx_20533_index_sipity_entities_on_workflow_state_id"
  end
  ...
  create_table "sipity_entity_specific_responsibilities", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["agent_id"], name: "idx_20538_sipity_entity_specific_responsibilities_agent"
    t.index ["entity_id"], name: "idx_20538_sipity_entity_specific_responsibilities_entity"
    t.index ["workflow_role_id", "entity_id", "agent_id"], name: "idx_20538_sipity_entity_specific_responsibilities_aggregate", unique: true
    t.index ["workflow_role_id"], name: "idx_20538_sipity_entity_specific_responsibilities_role"
  end
  ...
  create_table "sipity_notifiable_contexts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["notification_id"], name: "idx_20543_sipity_notifiable_contexts_notification_id"
    t.index ["scope_for_notification_id", "scope_for_notification_type", "reason_for_notification", "notification_id"], name: "idx_20543_sipity_notifiable_contexts_concern_surrogate", unique: true
    t.index ["scope_for_notification_id", "scope_for_notification_type", "reason_for_notification"], name: "idx_20543_sipity_notifiable_contexts_concern_context"
  ...
  create_table "sipity_notification_recipients", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["notification_id", "role_id", "recipient_strategy"], name: "idx_20557_sipity_notifications_recipients_surrogate"
    t.index ["notification_id"], name: "idx_20557_sipity_notification_recipients_notification"
    t.index ["recipient_strategy"], name: "idx_20557_sipity_notification_recipients_recipient_strategy"
    t.index ["role_id"], name: "idx_20557_sipity_notification_recipients_role"
  end
  ...
  create_table "sipity_notifications", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "idx_20550_index_sipity_notifications_on_name", unique: true
    t.index ["notification_type"], name: "idx_20550_index_sipity_notifications_on_notification_type"
  end
  ...
  create_table "sipity_roles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "idx_20562_index_sipity_roles_on_name", unique: true
  end
  ...
  create_table "sipity_workflow_actions", force: :cascade do |t|
    ...
    t.index ["workflow_id", "name"], name: "idx_20577_sipity_workflow_actions_aggregate", unique: true
    t.index ["workflow_id"], name: "idx_20577_sipity_workflow_actions_workflow"
  end
  ...
  create_table "sipity_workflow_methods", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["workflow_action_id"], name: "idx_20582_index_sipity_workflow_methods_on_workflow_action_id"
  end
  ...
  create_table "sipity_workflow_responsibilities", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["agent_id", "workflow_role_id"], name: "idx_20587_sipity_workflow_responsibilities_aggregate", unique: true
  end
  ...
  create_table "sipity_workflow_roles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["workflow_id", "role_id"], name: "idx_20592_sipity_workflow_roles_aggregate", unique: true
  end
  ...
  create_table "sipity_workflow_state_action_permissions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["workflow_role_id", "workflow_state_action_id"], name: "idx_20607_sipity_workflow_state_action_permissions_aggregate", unique: true
  end
  ...
  create_table "sipity_workflow_state_actions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["originating_workflow_state_id", "workflow_action_id"], name: "idx_20602_sipity_workflow_state_actions_aggregate", unique: true
  end
  ...
  create_table "sipity_workflow_states", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "idx_20597_index_sipity_workflow_states_on_name"
    t.index ["workflow_id", "name"], name: "idx_20597_sipity_type_state_aggregate", unique: true
  end
  ...
  create_table "sipity_workflows", force: :cascade do |t|
    ...
    t.index ["permission_template_id", "name"], name: "idx_20569_index_sipity_workflows_on_permission_template_and_nam", unique: true
  end
  ...
  create_table "sony_ci_webhook_logs", force: :cascade do |t|
    ...
    t.index ["guids"], name: "idx_20612_index_sony_ci_webhook_logs_on_guids"
  end
  ...
  create_table "uploaded_files", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["file_set_uri"], name: "idx_20636_index_uploaded_files_on_file_set_uri"
    t.index ["user_id"], name: "idx_20636_index_uploaded_files_on_user_id"
  end
  ...
  create_table "user_stats", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "work_views"
    t.index ["user_id"], name: "idx_20681_index_user_stats_on_user_id"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean "deleted", default: false
    t.index ["email"], name: "idx_20645_index_users_on_email", unique: true
    t.index ["reset_password_token"], name: "idx_20645_index_users_on_reset_password_token", unique: true
  end
  ...
  create_table "work_view_stats", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id"
    t.index ["user_id"], name: "idx_20697_index_work_view_stats_on_user_id"
    t.index ["work_id"], name: "idx_20697_index_work_view_stats_on_work_id"
  end
