...
module Hyrax
  class AssetForm < Hyrax::Forms::WorkForm
    ...
    self.terms += [:resource_type, :broadcast, :created, :date, :copyright_date, :episode_number, :description, :spatial_coverage, :temporal_coverage, :audience_level, :audience_rating, :annotiation, :rights_summary, :rights_link]
