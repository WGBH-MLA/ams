...
module Hyrax
  class PhysicalInstantiationForm < Hyrax::Forms::WorkForm
    ...
    self.terms += [:date, :digitization_date, :dimensions, :format, :standard, :location, :media_type, :generations, :time_start, :duration, :colors, :rights_summary, :rights_link, :annotiation, :local_instantiation_identifer, :tracks, :channel_configuration, :alternative_modes]
