...
module Hyrax
  class DigitalInstantiationForm < Hyrax::Forms::WorkForm
    ...
    self.terms += [:date, :dimensions, :digital_format, :standard, :location, :media_type, :generations,:file_size, :time_start, :duration, :data_rate, :colors, :rights_summary, :rights_link, :annotation, :local_instantiation_identifer, :tracks, :channel_configuration, :alternative_modes]
